...
{
    /* <div className="flex gap-y-5 flex-grow justify-evenly bg-workGreyLight  p-5 items-center flex-wrap md:flex-nowrap">
<img className=" max-h-96  shadow-sm" src={project.projectImage1} alt="" />
<img className=" max-h-96 shadow-sm" src={project.projectImage2} alt="" />
</div> */
}
...
<AiOutlineCloseSquare
    onClick={toggleModal}
    className="text-3xl hover:text-aboutOrangeDark duration-500 ease-in-out"
/>
</button> */
}
...
<div className="sm:flex sm:flex-col gap:10  gap-10 p-3 sm:w-1/3 bg-workBlue">
    <div>
        <p className="uppercase text-sm font-semibold">Type</p>
    ...
    <div>
        <p className="uppercase text-sm font-semibold">Client/Name</p>
        <p className="text-lg  font-light">{project.name}</p>
    </div>

    <div>
        <p className="uppercase text-sm font-semibold">About</p>
        <p className="text-lg  font-light">{project.about}</p>
    </div>

    <div>
        <p className="uppercase text-sm font-semibold">Tools/tech</p>
        <p className="text-lg  font-light">{project.tools}</p>
    </div>
</div>
<div className="grid sm:grid-cols-2 col-span-1 justify-center py-4 justify-items-center gap-10 sm:gap-0 items-center">
    <img className="max-w-xs max-h-96 shadow-sm" src={project.projectImage1} alt="" />
    <img className="max-w-xs max-h-96 shadow-sm" src={project.projectImage2} alt="" />
</div> */
}
