            ...
            <div className="grid md:grid-cols-2 text-center items-center  bg-contactRed ">
                <div className="flex justify-center order-1 sm:order-0 flex-col items-center px-5  h-full patternBack3 ">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="bg-green-500 w-28 text-xl p-3  text-center self-end mt-5 text-workGreyDark duration-500 ease-in-out transform hover:shadow-squareShadow"
                        >
                            Send
                        </button>
                    </form>
                ...
                <div className="grid text-left order-0 sm:order-1 justify-items-center  lg:justify-center space-y-5">
                    ...
                    <p className="w-2/4  text-sm md:text-lg sm:ml-40 z-10 uppercase">
                    ...
                    <div className="bg-workGreyLight h-60 w-56 lg:h-60 xl:w-96 absolute sm:justify-items-startml-36 lg:ml-60  z-0 about-shape bg-paperBack3  bg-center bg-cover"></div>
                </div>
            </div>
        </div>
    );
