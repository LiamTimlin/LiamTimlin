        ...
        <div className=" h-full md:h-5/6  grid ">
            <div className="grid md:grid-cols-2 text-center items-center  bg-aboutOrangeLight ">
                <div className="grid text-left justify-items-center ">
                    ...
                    <p className="w-2/5 lg:w-1/4 text-sm md:text-lg z-10 uppercase">
                    ...
                    <div className="bg-aboutOrangeDark h-96 w-40 absolute   lg:ml-36 ml-32 z-0 about-shape bg-paperBack  bg-center bg-cover "></div>
                </div>

                <div className="flex  flex-col items-center gap-10 patternBack h-full justify-center pt-10">
                    <div>
                        <img className="w-72 h-72 lg:w-96 lg:h-96 about-pic-shape object-contain" src={profilePic} alt="William Timlin profile image " />
                    </div>
